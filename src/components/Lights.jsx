...
const Lights = () => {
  return (
    // group different lights and . We can use group to organize lights, cameras, meshes, and other objects in the scene.
    <group name="lights">
      {/**
      ...
      <Environment resolution={256}>
        <group>
          {/**
           * @description (light formers) used to create custom lights with various shapes and properties in a 3D scene.
